      ...
      >
        <div className="text-center p-8 max-w-sm w-full">
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter" && password === ADMIN_PASS)
          ...
          <Link
            to="/"
            className="text-white/30 text-xs mt-4 inline-block hover:text-white/50"
          >
            ← رجوع
          </Link>
        </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h2 className="text-white text-xl font-bold">
                        {selectedMerchant.businessNameAr ||
                  ...
                  {selectedMerchant.status === "pending" && (
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          updateStatus(selectedMerchant.id, "approved")
                        }
                      ...
                      <button
                        onClick={() =>
                          updateStatus(selectedMerchant.id, "rejected")
                        }
