...
export default function MerchantRegister() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0a1628] to-[#1a2744] flex items-center justify-center" dir="rtl">
        <div className="text-center p-8">
          ...
          <p className="text-gray-300 mb-2">Your application has been submitted successfully!</p>
